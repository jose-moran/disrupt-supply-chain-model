class CommercialLink(object):
    ...
    def __init__(self, pid=None, supplier_id=None, buyer_id=None, product=None,
        ...
        # service, manufacturing, etc. (=sector_type)
        ...
        # flows downstream. What is supposed to be delivered (if no transport pb)
    ...
    def print_info(self):
        ...
        attribute_to_print = [a for a in dir(self) if not a.startswith(
    ...
    def storeRouteInformation(self, route, transport_mode,
        ...
        distance, route_time_cost, cost_per_ton = transport_network.giveRouteCaracteristics(
            route)
        ...
        if main_or_alternative == "main":
            ...
            raise ValueError(
                "'main_or_alternative' is not in ['main', 'alternative']")
